...
import 'package:mmth_flutter/chat.dart';
import 'package:mmth_flutter/const.dart';
import 'package:mmth_flutter/settings.dart';
import 'package:mmth_flutter/widget/loading.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  void showNotification(message) async {
    var androidPlatformChannelSpecifics = new AndroidNotificationDetails(
      Platform.isAndroid ? 'com.mmth.mmth_flutter' : 'com.mmth.mmth_flutter',
      'Flutter chat demo',
